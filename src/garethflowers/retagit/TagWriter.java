...
public class TagWriter {
	...
	private String Generate() {
		...
		cmd += " --year \""
				+ Integer.toString(this.currentTag.getReleaseDate()) + "\"";
		...
		cmd += " --compilation "
				+ Boolean.toString(this.currentTag.getIsCompilation());
		cmd += " --podcastFlag "
				+ Boolean.toString(this.currentTag.getIsPodcast());
		...
		cmd += " --TVSeasonNum \""
				+ Integer.toString(this.currentTag.getTvSeasonNum()) + "\"";
		cmd += " --TVEpisodeNum \""
				+ Integer.toString(this.currentTag.getTvEpisodeNum()) + "\"";
