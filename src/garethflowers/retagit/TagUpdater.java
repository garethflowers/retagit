...
public class TagUpdater extends Thread {
    ...
    public void run() {
        ...
        if (written) {
            JOptionPane.showMessageDialog(Parent, "Tag Updating Complete", "Complete", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(Parent, "Tag Updating Failed!", "Failed", JOptionPane.ERROR_MESSAGE);
        }
    }
}
