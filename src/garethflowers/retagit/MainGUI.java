...
public final class MainGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setFont(jLabel6.getFont().deriveFont(
                jLabel6.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel7.setFont(jLabel7.getFont().deriveFont(
                jLabel7.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel9.setFont(jLabel9.getFont().deriveFont(
                jLabel9.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel10.setFont(jLabel10.getFont().deriveFont(
                jLabel10.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel11.setFont(jLabel11.getFont().deriveFont(
                jLabel11.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel12.setFont(jLabel12.getFont().deriveFont(
                jLabel12.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel8.setFont(jLabel8.getFont().deriveFont(
                jLabel8.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel13.setFont(jLabel13.getFont().deriveFont(
                jLabel13.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel14.setFont(jLabel14.getFont().deriveFont(
                jLabel14.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel15.setFont(jLabel15.getFont().deriveFont(
                jLabel15.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel16.setFont(jLabel16.getFont().deriveFont(
                jLabel16.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel17.setFont(jLabel17.getFont().deriveFont(
                jLabel17.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel17.setLabelFor(jTextBPM);
        jLabel17.setText("BPM");
        jLabel17.setDoubleBuffered(true);

        jLabel18.setFont(jLabel18.getFont().deriveFont(
                jLabel18.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jComboGenre.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
                " ", "Alternative", "AlternRock", "Blues", "Classic Rock",
                "Country", "Dance", "Disco", "Funk", "Grunge", "Hip-Hop",
                "Industrial", "Jazz", "Metal", "New Age", "Oldies", "Other",
        ...
        jComboRating.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { " ", "U", "PG", "12", "12A", "15", "18", "E" }));
        jComboRating.setDoubleBuffered(true);

        jLabel20.setFont(jLabel20.getFont().deriveFont(
                jLabel20.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel19.setFont(jLabel19.getFont().deriveFont(
                jLabel19.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel21.setFont(jLabel21.getFont().deriveFont(
                jLabel21.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel21.setLabelFor(jTextEpisodeID);
        jLabel21.setText("Episode ID");
        jLabel21.setDoubleBuffered(true);

        jLabel22.setFont(jLabel22.getFont().deriveFont(
                jLabel22.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jLabel23.setFont(jLabel23.getFont().deriveFont(
                jLabel23.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel23.setLabelFor(jComboRating);
        jLabel23.setText("Rating");
        jLabel23.setDoubleBuffered(true);

        jLabel24.setFont(jLabel24.getFont().deriveFont(
                jLabel24.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel24.setLabelFor(jComboHD);
        jLabel24.setText("HD");
        jLabel24.setDoubleBuffered(true);

        jComboHD.setFont(jComboHD.getFont());
        jComboHD.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
                "Yes", "No" }));
        jComboHD.setSelectedIndex(1);
        jComboHD.setDoubleBuffered(true);

        jLabel29.setFont(jLabel29.getFont().deriveFont(
                jLabel29.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        javax.swing.GroupLayout jPanelVideoLayout = new javax.swing.GroupLayout(
                jPanelVideo);
        jPanelVideo.setLayout(jPanelVideoLayout);
        jPanelVideoLayout
                .setHorizontalGroup(jPanelVideoLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                jPanelVideoLayout
                                        ...
                                        .addContainerGap()));
        jPanelVideoLayout
                .setVerticalGroup(jPanelVideoLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                jPanelVideoLayout
        ...
        jLabel31.setFont(jLabel31.getFont().deriveFont(
                jLabel31.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel31.setLabelFor(jTextCnID);
        jLabel31.setText("Catalog ID");
        ...
        javax.swing.GroupLayout jPaneliTunesLayout = new javax.swing.GroupLayout(
                jPaneliTunes);
        jPaneliTunes.setLayout(jPaneliTunesLayout);
        jPaneliTunesLayout
                .setHorizontalGroup(jPaneliTunesLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                jPaneliTunesLayout
        ...
        jPaneliTunesLayout
                .setVerticalGroup(jPaneliTunesLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                jPaneliTunesLayout
        ...
        jLabel4.setFont(jLabel4.getFont().deriveFont(
                jLabel4.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel4.setLabelFor(jTextEncodedBy);
        jLabel4.setText("Encoded By");
        jLabel4.setDoubleBuffered(true);

        jComboMediaType.setFont(jComboMediaType.getFont());
        jComboMediaType.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Music", "Movie", "Music Video", "TV Show" }));
        jComboMediaType.setDoubleBuffered(true);

        jLabel25.setFont(jLabel25.getFont().deriveFont(
                jLabel25.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel25.setLabelFor(jComboMediaType);
        jLabel25.setText("Media Type");
        jLabel25.setDoubleBuffered(true);

        jLabel26.setFont(jLabel26.getFont().deriveFont(
                jLabel26.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jComboAdvisory.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "N/A", "Clean Content", "Explicit Content" }));
        jComboAdvisory.setDoubleBuffered(true);

        jLabel27.setFont(jLabel27.getFont().deriveFont(
                jLabel27.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel27.setLabelFor(jComboAdvisory);
        jLabel27.setText("Lyrics Advisory");
        jLabel27.setDoubleBuffered(true);

        jLabel28.setFont(jLabel28.getFont().deriveFont(
                jLabel28.getFont().getStyle() | java.awt.Font.BOLD));
        ...
        jComboCompilation.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Yes", "No" }));
        ...
        jComboPodcast.setModel(new javax.swing.DefaultComboBoxModel(
                new String[] { "Yes", "No" }));
        jComboPodcast.setSelectedIndex(1);
        jComboPodcast.setDoubleBuffered(true);

        jLabel30.setFont(jLabel30.getFont().deriveFont(
                jLabel30.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel30.setLabelFor(jComboPodcast);
        jLabel30.setText("Podcast");
        jLabel30.setDoubleBuffered(true);

        javax.swing.GroupLayout jPanelAdditionalLayout = new javax.swing.GroupLayout(
                jPanelAdditional);
        jPanelAdditional.setLayout(jPanelAdditionalLayout);
        jPanelAdditionalLayout
                .setHorizontalGroup(jPanelAdditionalLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                jPanelAdditionalLayout
                                        ...
                                        .addContainerGap()));
        jPanelAdditionalLayout
                .setVerticalGroup(jPanelAdditionalLayout
                        .createParallelGroup(
                                javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(
                                jPanelAdditionalLayout
    ...
    private void jMenuItemHelpAboutActionPerformed(
            java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItemHelpAboutActionPerformed
    ...
    private void jMenuItemFileCloseActionPerformed(
            java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItemFileCloseActionPerformed
        CloseFile();
    ...
    private void setCurrentFromGUI() {
        ...
        if (this.jComboGenre.getSelectedItem() != null) {
            this.Current
                    .setGenre(this.jComboGenre.getSelectedItem().toString());
        } else {
            this.Current.setGenre("");
        }
        try {
            this.Current.setReleaseDate(Integer.parseInt(this.jTextReleaseDate
                    .getText()));
        } catch (NumberFormatException e) {
            this.Current.setReleaseDate(0);
        }
        try {
            this.Current.setTvEpisodeNum(Integer
                    .parseInt(this.jTextEpisodeNumber.getText()));
        } catch (NumberFormatException e) {
            this.Current.setTvEpisodeNum(0);
        }
        try {
            this.Current.setTvSeasonNum(Integer.parseInt(this.jTextSeries
                    .getText()));
        } catch (NumberFormatException e) {
        ...
        try {
            this.Current.setTrackTotal(Integer.parseInt(this.jTextTrackTotal
                    .getText()));
        } catch (NumberFormatException e) {
        ...
        try {
            this.Current.setDiscTotal(Integer.parseInt(this.jTextDiscTotal
                    .getText()));
        } catch (NumberFormatException e) {
    ...
    protected void setGuiFromCurrent() {
        if (this.Current.getFilename() == null
                || this.Current.getFilename().length() == 0) {
        ...
        if (this.Current.getTvEpisodeNum() > 0) {
            this.jTextEpisodeNumber.setText(Integer.toString(this.Current
                    .getTvEpisodeNum()));
        } else {
            this.jTextEpisodeNumber.setText("");
        }
        if (this.Current.getTvSeasonNum() > 0) {
            this.jTextSeries.setText(Integer.toString(this.Current
                    .getTvSeasonNum()));
        } else {
        ...
        if (this.Current.getReleaseDate() > 0) {
            this.jTextReleaseDate.setText(Integer.toString(this.Current
                    .getReleaseDate()));
        } else {
        ...
        if (this.Current.getTrackTotal() > 0) {
            this.jTextTrackTotal.setText(Integer.toString(this.Current
                    .getTrackTotal()));
        } else {
        ...
        if (this.Current.getDiscTotal() > 0) {
            this.jTextDiscTotal.setText(Integer.toString(this.Current
                    .getDiscTotal()));
        } else {
    ...
    private void OpenFile() {
        if (jFileChooser1.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            this.Current = new Tag(jFileChooser1.getSelectedFile()
                    .getAbsolutePath());
    ...
    private void ValidateLength(java.awt.event.KeyEvent evt, String text,
            int length) {
